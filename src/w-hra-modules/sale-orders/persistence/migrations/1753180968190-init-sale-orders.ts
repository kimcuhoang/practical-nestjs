...
export class InitSaleOrders1753180968190 implements MigrationInterface {
    name = 'InitSaleOrders1753180968190'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "sale_order_items" ADD CONSTRAINT "FK_SaleOrderLineItem_SaleOrder" FOREIGN KEY ("sale_order_id") REFERENCES "sale_orders"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "sale_order_shipment_histories" ADD CONSTRAINT "FK_SaleOrderShipmentHistory_SaleOrder" FOREIGN KEY ("sale_order_id") REFERENCES "sale_orders"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "sale_order_shipment_histories" DROP CONSTRAINT "FK_SaleOrderShipmentHistory_SaleOrder"`);
