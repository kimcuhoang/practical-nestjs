...
export class InitTariffs1761631692816 implements MigrationInterface {
    name = 'InitTariffs1761631692816'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "base_rate_values" ("id" character varying(26) NOT NULL, "deleted" boolean, "created_at" TIMESTAMP NOT NULL, "modified_at" TIMESTAMP DEFAULT now(), "deleted_at" TIMESTAMP, "base_rate_type" character varying NOT NULL, "base_rate_id" character varying NOT NULL, "value" double precision NOT NULL, "per_segment" integer, "segment_unit" character varying, "per_number_of_stops" integer, CONSTRAINT "PK_25c1a4b69f1fa64a25d5cee4dac" PRIMARY KEY ("id"))`);
