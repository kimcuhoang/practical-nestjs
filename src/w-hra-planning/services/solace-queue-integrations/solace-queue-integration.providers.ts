...
import { ISubscriptionInstanceBootstrap, SubscriptionInstanceBootstrapsSymbol } from "@src/infra-modules/solace-queue/instances/subscription-instance.bootstrap";
