...
export class Init1742802383341 implements MigrationInterface {
    name = 'Init1742802383341'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "yan_entity" ("id" SERIAL NOT NULL, "name" character varying(100) NOT NULL, "created_at_utc" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_56cca1737847a0b439eed6a7a95" PRIMARY KEY ("id"))`);
    }
